<template>
  <div>
    ...
    <!--  设计单-->
    <el-dialog width="80%" title="物料组成设计单变更" :visible="zdwinshow">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="shenhei">重新提交</el-button>
      </div>
    </el-dialog>
  ...
  export default {
    ...
    methods: {
      ...
      shenhei(){
        ...
        this.$axios.post("/dModule/upDFile").then(function (response) {
