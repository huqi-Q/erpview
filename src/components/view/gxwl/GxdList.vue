<template>
  <div>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                    ...
                    ><a href="#" @click.prevent='wf1(scope.row.procedureName)'>设计</a>
                    </span>
                <span
                  v-else-if="scope.row.designModuleTag == 'D002-1'"
                  style="color:black"
                ><a href="#" @click.prevent='wf2'>重新设计</a>
                </span>
              </template>
            </el-table-column>
          </el-table>
    ...
    <!--工序表格-->
    <el-dialog width="80%" :title="'('+scFrom.productName+')产品制造工序供选择的物料如下：'" :visible="gxwinshow">
      <!--生产工序-->
      <div>
        <el-table
