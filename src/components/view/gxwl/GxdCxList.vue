<template>
  <div>
    ...
    <el-form :model="productFrom" ref="productFrom"  :inline="true">
      ...
      <el-form-item label="请选择工序物料设计单状态">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
                    <span v-if="scope.row.designModuleTag =='G002-1'"
                          style="color:lawngreen"
                    >执行</span>
          <span
            v-else-if="scope.row.designModuleTag == 'G002-2'"
            style="color:black"
          >完成</span>
          <span
            v-else
      ...
      <el-table-column
        ...
        label="审核状态">
        <template slot-scope="scope">
          <span v-if="scope.row.designModuleTag =='G002-1'" style="color:lawngreen">等待</span>
          <span v-else-if="scope.row.designModuleTag == 'G002-2'" style="color:black">通过</span>
