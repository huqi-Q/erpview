  ...
  <div>
    ...
    <el-table :data="tableData" stripe border style="width: 100%">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <a href="#" @click.prevent='zhidin(scope.row.id)'>复核</a>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页-->
        ...
        <el-row>
          <el-col :span="12">
            <div class="grid-content bg-purple">
              ...
              <input class="xhx" style="width:200px" v-model="scFrom1.minAmount"></input>
            </div>
          </el-col>
          <el-col :span="12">
  ...
  export default {
    ...
    methods: {
      getdata() {   //获取数据
        ...
        axios.post("/sCell/selectSCellbyidtoexamine.action", params).then(function (response) {
