...
<!--产品档案登记复核-->
  ...
  <el-table
    ...
    <el-table-column
      label="复核">
      <template slot-scope="scope">
        <a href="#" @click.prevent='zd(scope.row.productId)'>复核</a>
      </template>
    </el-table-column>
  </el-table>
  <!-- 分页-->
  ...
  <!--弹出档案变更模态框-->
  <el-dialog width="80%" title="登记复核" :visible="upwinshow">
    ...
    <el-form :modal="ruleForm">
      ...
      <el-form-item>
        <el-button type="primary" @click="submitFile">复核</el-button>
        <el-button @click="upwinshow = false">返回</el-button>
      </el-form-item>
    </el-form>
  </el-dialog>
              ...
              export default {
                ...
                methods: {
                  getdata() {   //获取数据
                    ...
                    //产品档案
                    this.$axios.post("/dFile/queryallrecheckDFile", params).then(function (response) {
                  ...
                  submitFile(){
                    ...
                    this.$axios.post('/dFile/recheckDFile',params).then(function (response) {
