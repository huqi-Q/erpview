              ...
              export default {
                ...
                methods: {
                  getdata() {   //获取数据
                    ...
                    //产品档案
                    this.$axios.post("/dFile/delDFilePage", params).then(function (response) {
                  ...
                  del(row){
                   // this.upwinshow = true;
                    ...
                    _this.$confirm('您确定要删除'+row.productName+'这档案例吗?','删除案例',{
                      confirmButtonText:'确定',
                      cancelButtonText:'取消',
                      type: 'warning'
                    }).then(()=>{
                      this.$axios.post("/dFile/delDFile",params).then(function (response) {
